...
```{r ges set seed, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r voc set seed, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r mult set seed, echo=TRUE, message=FALSE, warning=FALSE}
