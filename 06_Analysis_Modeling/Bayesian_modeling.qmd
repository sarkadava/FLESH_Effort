---
title: "Modeling the effect of correction on physical effort"
format:
  html:
    code-overflow: wrap
...
This is the feature dataframe we will be using. It contains all features colected in [previous script](..\05_TS_featureExtraction\01_TS_extraction.ipynb#sec-features){target="_blank"}, together with demographic information about the participants. For confirmatory analysis, we will need only 6 features - arm torque integral, arm torque peak mean, COPc integral, COPc peak mean, envelope integral and envelope peak mean from the data_feat. From demographics, we will need only BFI and Familiarity
...
```{r}
#| echo: false
#| fig-cap: "Distribution of cumulative torque"
#| label: cum-torq-dis
#| fig-width: 12.5   # inches → ~1200px at 96dpi
#| fig-height: 10
#| out-width: "100%"
...
```{r}
#| code-fold: true
#| code-summary: Code to generate convergence metrics
#| eval: false
...
```{r}
#| echo: false
#| tbl-cap: "Cumulative torque: convergence metrics"
#| label: tbl-conv-cum-torq

convergence_results_tc <- read_csv(paste0(summaries, "convergence_comparison_torq_cum.csv"))
knitr::kable(convergence_results_tc, format = "pipe")
...
```{r}
#| tbl-cap: "Cumulative torque: summary for all models"
#| label: tbl-cum-torq-all
#| echo: false

param_table_torq_cum <- read_csv(paste0(summaries, "parameter_table_h1_torq_cum.csv"))
knitr::kable(param_table_torq_cum, format = "pipe")
...
```{r}
#| fig-cap: "Cumulative torque: report and visualization for selected model"
#| label: fig-cum-torq
#| echo: false
#| fig-width: 12.5   # inches → ~1200px at 96dpi
#| fig-height: 10
...
```{r}
#| echo: false
#| fig-cap: "Distribution of instantenous torque"
#| label: inst-torq-distr
#| fig-width: 12.5   # inches → ~1200px at 96dpi
#| fig-height: 10
#| out-width: "100%"
...
```{r}
#| echo: false
#| tbl-cap: "Instant torque: convergence metrics"
#| label: tbl-inst-torq-conv

convergence_results_ti <- read_csv(paste0(summaries, "convergence_comparison_torq_in.csv"))
knitr::kable(convergence_results_ti, format = "pipe")
...
```{r}
#| tbl-cap: "Instant torque: summary for all models"
#| label: tbl-inst-torq-all
#| echo: false

param_table_torq_in <- read_csv(paste0(summaries, "parameter_table_h1_torq_in.csv"))
knitr::kable(param_table_torq_in, format = "pipe")
```
...
```{r}
#| fig-cap: "Instantenous torque: report and visualization for selected model"
#| label: fig-inst-torq
#| echo: false
#| fig-width: 12.5   # inches → ~1200px at 96dpi
#| fig-height: 10
...
```{r}
#| echo: false
#| fig-cap: "Distribution of cumulative envelope"
#| label: cum-env-distr
#| fig-width: 12.5   # inches → ~1200px at 96dpi
#| fig-height: 10
#| out-width: "100%"
...
```{r}
#| echo: false
#| tbl-cap: "Cumulative envelope: convergence metrics"
#| label: tbl-cum-env-conv

convergence_results_ec <- read_csv(paste0(summaries, "convergence_comparison_env_cum.csv"))
knitr::kable(convergence_results_ec, format = "pipe")
...
```{r}
#| tbl-cap: "Cumulative envelope: summary for all models"
#| label: tbl-cum-env-all
#| echo: false

param_table_env_cum <- read_csv(paste0(summaries, "parameter_table_h1_env_cum.csv"))
knitr::kable(param_table_env_cum, format = "pipe")
```
...
```{r}
#| echo: false
#| fig-cap: "Cumulative envelope: report and visualization for selected model"
#| label: fig-cum-env
#| fig-width: 12.5   # inches → ~1200px at 96dpi
#| fig-height: 10
#| out-width: "100%"
...
```{r}
#| echo: false
#| fig-cap: "Distribution of instantenous envelope"
#| label: env-inst-distr
#| fig-width: 12.5   # inches → ~1200px at 96dpi
#| fig-height: 10
#| out-width: "100%"
...
```{r}
#| echo: false
#| tbl-cap: "Instantenous envelope: convergence metrics"
#| label: tbl-inst-env-conv

convergence_results_ei <- read_csv(paste0(summaries, "convergence_comparison_env_in.csv"))
knitr::kable(convergence_results_ei, format = "pipe")
...
```{r}
#| tbl-cap: "Instantenous envelope: summary for all models"
#| label: tbl-inst-env-all
#| echo: false

param_table_env_in <- read_csv(paste0(summaries, "parameter_table_h1_env_in.csv"))
knitr::kable(param_table_env_in, format = "pipe")
```
...
```{r}
#| fig-cap: "Instantenous envelope: selected model report and visualization"
#| label: fig-inst-env
#| echo: false
#| fig-width: 12.5   # inches → ~1200px at 96dpi
#| fig-height: 10
...
```{r}
#| echo: false
#| fig-cap: "Distribution of cumulative COPc"
#| label: copc-cum-distr
#| fig-width: 12.5   # inches → ~1200px at 96dpi
#| fig-height: 10
#| out-width: "100%"
...
```{r}
#| echo: false
#| tbl-cap: "Cumulative COPc: convergence metrics"
#| label: tbl-inst-env

convergence_results_cc <- read_csv(paste0(summaries, "convergence_comparison_cop_cum.csv"))
knitr::kable(convergence_results_cc, format = "pipe")
...
```{r}
#| tbl-cap: "Cumulative COPc: summary for all models"
#| label: tbl-cum-cop
#| echo: false

param_table_cop_cum <- read_csv(paste0(summaries, "parameter_table_h1_cop_cum.csv"))
knitr::kable(param_table_cop_cum, format = "pipe")
```
...
```{r}
#| echo: false
#| fig-cap: "Cumulative COPc: selected model report and visualization"
#| label: fig-cum-cop
#| fig-width: 12.5   # inches → ~1200px at 96dpi
#| fig-height: 10
#| out-width: "100%"
...
```{r}
#| echo: false
#| fig-cap: "Distribution of instantenous COPc"
#| label: inst-cop-distr
#| fig-width: 12.5   # inches → ~1200px at 96dpi
#| fig-height: 10
#| out-width: "100%"
...
```{r}
#| echo: false
#| tbl-cap: "Instantenous COPc: convergence metrics"
#| label: tbl-inst-cop-conv

convergence_results_ci <- read_csv(paste0(summaries, "convergence_comparison_cop_in.csv"))
knitr::kable(convergence_results_ci, format = "pipe")
...
```{r}
#| tbl-cap: "Instantenous COPc: summary for all models"
#| label: tbl-inst-cop-all
#| echo: false

param_table_cop_in <- read_csv(paste0(summaries, "parameter_table_h1_cop_in.csv"))
knitr::kable(param_table_cop_in, format = "pipe")
```
...
```{r}
#| fig-cap: "Instantenous COPc: selected model report and visualization"
#| label: fig-inst-cop
#| echo: false
#| fig-width: 12.5   # inches → ~1200px at 96dpi
#| fig-height: 10
...
```{r}
#| tbl-cap: "Model summary for all six variables"
#| label: tbl-all
#| echo: false

paper_table <- read_csv(paste0(summaries, "paper_table_H1.csv"))
...
```{r}
#| fig-cap: "Correction effect on effort (posterior distributions with raw scatter)"
#| label: fig-raincloud
#| echo: false
#| fig-width: 12.5   # inches → ~1200px at 96dpi
#| fig-height: 10
...
```{r}
#| fig-cap: "Duration distribution per correction & modality"
#| label: fig-time
#| echo: false
#| fig-width: 12.5   # inches → ~1200px at 96dpi
#| fig-height: 10
...
```{r}
#| tbl-cap: "H2 summary for all effort variables"
#| label: tbl-cos-sim
#| echo: false

paper_table_h2 <- read_csv(paste0(summaries, "paper_table_H2.csv"))
...
```{r}
#| tbl-cap: "E1 summary for all effort variables"
#| label: tbl-effcat
#| echo: false

paper_table_e1 <- read_csv(paste0(summaries, "paper_table_E1.csv"))
...
```{r}
#| tbl-cap: "E2 summary for all effort variables"
#| label: tbl-time
#| echo: false

paper_table_e2 <- read_csv(paste0(summaries, "paper_table_E2.csv"))
...
ggsave(here(plots, "e3m1b_channel_correlations_by_modality.png"),
       result$plot, width = 12, height = 8, dpi = 300)
```
...
ggsave(here(plots, "e3.m3b_att_channel_correlations_by_modality.png"),
       result$plot, width = 12, height = 8, dpi = 300)
```
...
```{r}
#| tbl-cap: "E3 summary for all success outcomes"
#| label: tbl-success
#| echo: false

paper_table_e3 <- read_csv(paste0(summaries, "paper_table_E3.csv"))
