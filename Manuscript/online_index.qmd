...
All preregistrations are reported in a [separate document](Prereg-deviations.qmd) and each script is available as a change-tracking report in the Github repository (LINK).
