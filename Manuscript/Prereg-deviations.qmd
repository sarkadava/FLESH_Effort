...
Additionally, all pre-registered scripts are compared side-by-side with the final versions to allow for direct, transparent comparison. This is available at [https://github.com/sarkadava/FLESH_Effort/tree/main/Prereg_deviations](https://github.com/sarkadava/FLESH_Effort/tree/main/Prereg_deviations){target="_blank"}.
