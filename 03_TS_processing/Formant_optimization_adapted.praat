...
form calculate_formants
	#indicate where your sound files and TextGrid are
	sentence input_folder F:\flesh_data_processed\48_1_praat
	#indicate where you want your output to be saved
	sentence output_folder F:\flesh_data_processed\03_TS_processing\TS_acoustics
endform
...
for z from 1 to ns
	...
	select Table formants
	Rename... 'filename$'_table_formants
	select Table 'filename$'_table_formants
	Save as comma-separated file... 'output_folder$'\'filename$'_table_formants.csv
