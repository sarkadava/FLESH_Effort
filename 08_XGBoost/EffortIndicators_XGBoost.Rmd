...
processfolder <- paste0(parentfolder, '/07_TS_featureExtraction/')
data          <- paste0(processfolder, '/Datasets/')

datasets      <- paste0(parentfolder, '/08_XGBoost/datasets/')
models        <- paste0(parentfolder, '/08_XGBoost/models/')
plots         <- paste0(parentfolder, '/08_XGBoost/plots/')
...
colstoremove <- c('envelope', 'loudness', 'roughness', 'flux', 'novelty', 
                     'harmEnergy', 'audio', 'envelope_change', 'f0', 
                     'f1', 'f2', 'f3', 'env_', 'duration_voc')
